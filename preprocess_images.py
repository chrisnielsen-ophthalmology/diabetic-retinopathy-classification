"""
Preprocessing code adapted from https://github.com/aladdinpersson/Machine-Learning-Collection/tree/master/ML/Kaggles/DiabeticRetinopathy
Tries to remove unnecessary black borders around the images, and "trim" the images to they take up the entirety of the image
"""
...
if __name__ == "__main__":
    fast_image_resize("C:/Data/Kaggle EyePACS/train/", "C:/Data/Kaggle EyePACS/train_images_resized_512/", output_size=(512, 512))
    fast_image_resize("C:/Data/Kaggle EyePACS/test/test", "C:/Data/Kaggle EyePACS/test_images_resized_512/", output_size=(512, 512))
